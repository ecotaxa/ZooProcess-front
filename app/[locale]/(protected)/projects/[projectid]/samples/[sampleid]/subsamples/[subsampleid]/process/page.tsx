  ...
  async function addTask(project: Project, sample: Sample, subsample: SubSample, scanId: string) {
    ...
    try {
      ...
      try {
        ...
        console.log(
          'ProcessNewScanPage::addProcessTask() RunTask error details:',
          error.response?.data
        );
              ...
              {error.message.includes('no background associated') && (
                <div className="mt-4">
                  <p className="text-amber-700">
                    You need to add a background scan before processing.
                  </p>
                  <a
