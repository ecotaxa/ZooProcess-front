...
export function BackgroundTimeline(param: {
  ...
  const [scanData, setScanData] /*:[IBackgroundScans,Dispatch<IBackgroundScans>]*/ = useState(
    param.initialScanData || {
          ...
          try {
            ...
            if (scanResponse) {
              if (scanResponse.error) {
                ...
                setScanData((prevState: IBackgroundScans) => ({
                  ...prevState,
                  backgroundId1: scanResponse.id,
                  background1: scanResponse.url,
                }));
                // }
          ...
          try {
            ...
            if (scanResponse) {
              if (scanResponse.error) {
                ...
                setScanData((prevState: IBackgroundScans) => ({
                  ...prevState,
                  backgroundId2: scanResponse.id,
                  background2: scanResponse.url,
                }));
                // }
                console.log('Go To the next page');
                setScanData((prevState: IBackgroundScans) => ({
