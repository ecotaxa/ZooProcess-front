  ...
  const Loader = (project: Project | any) => {
    ...
    return (
      <>
        ...
        <div>
          <b>instrument Id: </b> {project.instrumentId}
        </div>
        <Debug params={props} />
        ...
        <Card className="inline-block size-full" data-testid="ScanCard">
              ...
              <div>
                <ul className={'list-disc list-outside leading-loose'}>
                  ...
                  <li>
                    ...
                    <br /> The number of objects will be adapted to their size, and it's important
                    to limit the number of touching objects (multiple).
                  </li>
          ...
          <CardFooter className="flex flex-row-reverse py-3">
            <Button
              ...
              onPress={() => {
                console.debug('go to scan1');
                setCurrent(state.scan1);
              }}
              // onPress={onClick}
            >
              Done - Launch Preview
        ...
        <Card className="inline-block size-full" data-testid="ScanCard">
          ...
          <CardFooter className="flex flex-row-reverse py-3">
            <Button
              ...
              // onPress={onClick}
              onPress={() => {
                console.debug('go to scan2');
                setCurrent(state.scan2);
              }}
            >
              Done - Launch Preview
            </Button>
            ...
            <Button
              ...
              onPress={() => {
                if (current == state.scan1) {
                  console.debug('go to preview2');
                  setCurrent(state.preview2);
                } else {
                  onClick();
                }
              }}
