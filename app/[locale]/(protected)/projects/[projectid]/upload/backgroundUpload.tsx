...
const BackgroundUpload: FC<pageProps> = ({ params }) => {
  ...
  const Loader: FC<MyLoaderProps> = (props: MyLoaderProps) => {
    ...
    return (
      <>
        ...
        <div>
          <b>project Id: </b> {props.project.id}
        </div>
        <div>
          <b>instrument Id: </b> {props.project.instrumentId}
        </div>
        <div>
          <b>instrument Id JS: </b> {JSON.stringify(props.project.instrument)}
        </div>
          ...
          <CardBody className="p-6">
            <div className="bg-100 p-6">
              ...
              <div>
                ...
                {project.instrument && project.instrument.sn && (
            ...
            <div className="bg-100 p-6">
              ...
              <div>
                <ul className={'list-disc list-outside leading-loose'}>
                  ...
                  <li>
                    Spread the specimens homogeneously, but avoid placing specimens close and
                    parallel to the borders.
                    <br />
  ...
  const ThirtySeconds = (nextState: state) => {
    ...
    return <Timer initialTime={30} onComplete={handleTimerEnd} />;
  };
      ...
      return (
        <>
          <div className="flex-row">
            <Image className="height-auto" src={background} alt="uploaded image" height={446} />
          </div>
    ...
    return (
      <>
        ...
        <Card className="inline-block size-full" data-testid="ScanCard">
          ...
          <CardFooter className="flex flex-row-reverse py-3">{showImage()}</CardFooter>
        </Card>
      </>
    );
  };
