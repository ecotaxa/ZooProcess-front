...
const InstrumentDetail = (
  ...
  const AddButton = (instrument: any) => {
    ...
    if (instrument === null) {
      return <Button disabled>Add new setting</Button>;
    }
    ...
    <>
      ...
      <div className="text-center justify-center">
        ...
        <Card className="inline-block" data-testid="calibrationCard">
          <CardHeader className="flex flex-row-reverse py-3">{AddButton(instrument)}</CardHeader>
          <CardBody>
            {instrument && 'id' in instrument && (
              <CalibrationTable
