...
export function useUserByIdWithAuth(userId) {
  ...
  console.log("useUserByIdWithAuth() | userId :", userId)
    ...
    const { data=[], error=false, isLoading=true } = useSWR(`/users/${userId}`, api.getUserByIdWithAuth,
    {
      revalidateIfStale: false,
      revalidateOnFocus: false,
      revalidateOnReconnect: false
...
export function useUsers() {
  const { data=[], error=false, isLoading=true } = useSWR('/users/', api.getUsers ,
  {
      revalidateIfStale: false,
      revalidateOnFocus: false,
      revalidateOnReconnect: false
