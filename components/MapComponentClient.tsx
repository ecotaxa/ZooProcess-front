...
const MapComponentClient: React.FC<MapComponentProps> = ({ start, end, onChange: onCoordsChange }) => {
        ...
        return (
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px', width: '100%' }}>
                  <Input
                    label={t("End_Latitude")}  type='text'
                  ...
                  />
                  <Input
                    label={t("End_Longitude")} type='text'
        ...
        return (
            ...
            <div style={{ display: 'flex', alignItems: 'center' }}>
              ...
              <Input
                ...
                >
                  <SelectItem key="N" value="N">{t("North")}</SelectItem>
                  <SelectItem key="S" value="S">{t("South")}</SelectItem>
                </Select>
              </div>
            </div>
            ...
            <div style={{ display: 'flex', alignItems: 'center' }}>
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr 1fr', gap: '10px', width: '100%' }}>
                ...
                <Input
                  ...
                  >
                    <SelectItem key="E" value="E">{t("East")}</SelectItem>
                    <SelectItem key="W" value="W">{t("West")}</SelectItem>
                  </Select>
                  </div>
                  </div>
	...
	return (
      ...
      <CardBody >
        ...
        <Select
          ...
          >
            <SelectItem key="decimal" value="decimal">{t("Decimal_Degrees")}</SelectItem>
            <SelectItem key="dms" value="dms">{t("DMS")}</SelectItem>
          </Select>
            ...
            <Button onClick={clearEndPoint} style={{ marginTop: '20px' }}>{t("Clear_End_Point")}</Button>
