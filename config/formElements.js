export const sampleid_formElements = [
  {
    ...
    section: [
      ...
      },
      {
        ...
        name: 'sample_id',
        type: 'text',
        placeholder: 'Enter Sample ID, (no extension or space character allowed)',
        label: 'Sample ID',
        variant: 'outlined',
        required: true,
        xs: 12,
...
export const inputFormElements = [
  {
    ...
    section: [
      ...
      },
      {
        ...
        type: 'text',
        placeholder: 'Scientific Program',
      ...
      },
      {
        ...
        fullWidth: true,
        minValue: 0,
        helperText: 'value greater than zero',
    ...
    section: [
      {
        ...
        name: 'ctd_reference',
        type: 'text',
        placeholder: 'CTD Reference',
        label: 'CTD Reference',
        variant: 'outlined',
        required: false,
        trad: 'ctd_reference_sample_quality',
        xs: 12,
        sm: 6,
        fullWidth: true,
        minLength: 3,
      },
      {
        ...
        variant: 'outlined',
        required: false,
        trad: 'other_reference_sample_quality',
        xs: 12,
        sm: 6,
        fullWidth: true,
        minLength: 3,
  ...
  },
  {
    ...
    section: [
      ...
      {
        tag: 'TextField',
        name: 'net_sampling_type',
        placeholder: 'WP2, JB, Regent, Omori, Multinet...',
        label: 'Net sampling type',
        variant: 'outlined',
        fullWidth: true,
        required: true,
        xs: 12,
      ...
      },
      {
        ...
        minValue: 0,
        helperText: 'value greather than zero',
      },
      {
        tag: 'TextField',
        name: 'net_opening_surface',
        type: 'number',
        placeholder: 'Enter Net opening surface (m²)',
        label: 'Net opening surface',
        variant: 'outlined',
        fullWidth: true,
        required: true,
        xs: 12,
    ...
    section: [
      {
        ...
        name: 'maximum_depth',
        type: 'number',
        placeholder: 'Enter Maximun depth (m)',
        label: 'Maximun depth',
        variant: 'outlined',
        fullWidth: true,
        required: true,
      ...
      },
      {
        ...
        name: 'minimum_depth',
        type: 'number',
        placeholder: 'Enter Minimum depth (m)',
        label: 'Minimum depth',
        variant: 'outlined',
        fullWidth: true,
        required: true,
      ...
      },
      {
        tag: 'Select',
        type: 'select',
        name: 'quality_flag_for_depth_measurement',
        placeholder: 'Choose Quality depth measurement',
        label: 'Quality flag for depth measurement of the net',
        variant: 'outlined',
        fullWidth: true,
        required: true,
        xs: 12,
      ...
      },
      {
        ...
        name: 'ship_speed',
        type: 'number',
        placeholder: 'Enter Ship speed (knots) - 9999 if not documented',
        label: 'Ship Speed',
        variant: 'outlined',
        fullWidth: true,
        required: true,
      ...
      },
      {
        ...
        name: 'cable_speed',
        type: 'number',
        placeholder: 'Enter Net sampling type - 9999 if not documented',
        label: 'Cable speed',
        variant: 'outlined',
        required: true,
        xs: 12,
        ...
        minValue: 0,
        helperText: 'value greather than or equal to zero',
      },
      {
        tag: 'TextField',
        name: 'cable_angle_from_vertical',
        type: 'number',
        placeholder: 'Enter Net sampling type - 9999 if not documented',
        label: 'Cable angle from verticale',
        variant: 'outlined',
        fullWidth: true,
        required: true,
        xs: 12,
      ...
      },
      {
        ...
        name: 'cable_length',
        type: 'number',
        placeholder: 'Enter cable length - 9999 if not documented',
        label: 'Cable length',
        variant: 'outlined',
        fullWidth: true,
        required: true,
      ...
      },
      {
        ...
        type: 'number',
        placeholder: 'Enter sampling duration (minutes) - 9999 if not documented',
...
export const inputFormElements_tow_type_vertical = [
  {
    ...
    section: [
      {
        tag: 'TextField',
        name: 'ending_latitude_degree',
        type: 'number',
        placeholder: 'Enter Ending Latitude (degree)',
      ...
      {
        tag: 'TextField',
        name: 'ending_latitude_minute',
        type: 'number',
        placeholder: 'Enter Ending Latitude (minute)',
        ...
        minValue: 0,
        maxValue: 60,
        helperText: 'de 0 à 60',
        endAdornment: { pos: 'end', text: 'min' },
      },
      {
        tag: 'Select',
        name: 'ending_latitude_ns',
        type: 'select',
        placeholder: 'N/S',
        label: 'Latitude (N/S)',
        variant: 'outlined',
      ...
      {
        tag: 'TextField',
        name: 'ending_longitude_degree',
        type: 'number',
        placeholder: 'Enter Ending Longitude (degree)',
        ...
        minValue: 0,
        maxValue: 180,
        helperText: 'de 0 à 180°',
        endAdornment: { pos: 'end', text: '°' },
      },
      {
        tag: 'TextField',
        name: 'ending_longitude_minute',
        type: 'number',
        placeholder: 'Enter Ending Longitude (minute',
  ...
  },
  {
    ...
    section: [
      ...
      },
      {
        tag: 'TextField',
        name: 'ctd_reference',
        trad: 'ctd_reference_ship',
        placeholder: 'CTD reference (filename)',
        label: 'CTD reference',
        variant: 'outlined',
        required: true,
        xs: 12,
    ...
    section: [
      {
        ...
        name: 'number_of_tow',
        type: 'number',
        placeholder: 'Number of tow in the same sample',
        label: 'Number of tow in the same sample',
        variant: 'outlined',
        fullWidth: true,
        required: true,
        xs: 12,
      ...
      },
      {
        ...
        type: 'number',
        placeholder: 'Total filtered volume (m3). (sum of the nets). 99999 if unknown)',
      ...
      {
        tag: 'Select',
        name: 'quality_flag_filtered_volume',
        type: 'select',
        placeholder: 'Quality Flag of the filtered volume of the net',
        label: 'Quality Flag of the filtered volume of the net',
        variant: 'outlined',
        fullWidth: true,
        required: true,
        xs: 12,
      ...
      },
      {
        ...
        name: 'sample_comment',
        type: 'text',
        placeholder: 'Add sample comment',
        label: 'Add sample comment',
        variant: 'outlined',
        fullWidth: true,
        required: true,
        xs: 12,
...

      {
        ...
        name: 'number_of_jars',
        type: 'number',
        placeholder: 'Nb of jars for the sample, 9999 if not documented',
        label: 'Nb of jars for the sample, 9999 if not documented',
        variant: 'outlined',
        fullWidth: true,
        required: true,
        xs: 12,
      ...
      },
      {
        ...
        name: 'other_reference',
        type: 'text',
        trad: 'other_reference_sample',
        placeholder: 'Other reference (NaN if non applicable)',
        label: 'Other reference',
        variant: 'outlined',
        fullWidth: true,
        required: false,
...

      {
        ...
        name: 'jar_airtighness',
        placeholder: 'JAR airtighness',
        tag: 'Select',
        type: 'select',
        variant: 'outlined',
        fullWidth: true,
      ...
      {
        tag: 'Select',
        name: 'sample_richness',
        type: 'select',
        placeholder: 'Sample richness',
        label: 'Sample richness',
        variant: 'outlined',
        fullWidth: true,
        required: true,
        xs: 12,
      ...
      {
        tag: 'Select',
        name: 'sample_conditioning',
        type: 'select',
        placeholder: 'Sample conditioning',
...
export const fraction_inputFormElments = [
  {
    ...
    section: [
      ...
      // },
      {
        ...
        name: 'fraction_id',
        type: 'text',
        placeholder: 'Fraction identifier  tot, d1, d2, ...',
      ...
      },
      {
        ...
        type: 'text',
        placeholder: 'Could be 01,02, ...',
        label: 'Fraction ID Suffix',
        variant: 'outlined',
        required: false,
        disabled: false,
        xs: 4,
        sm: 2,
        fullWidth: true, //value:2,
        refresh: 'scan_id',
      },
      ...
      // },
      {
        ...
        type: 'text',
        placeholder: 'Scanning operator',
        label: 'Scanning operator',
        variant: 'outlined',
        required: false,
        disabled: true,
        xs: 12,
  ...
  },
  {
    ...
    section: [
      ...
      },
      {
        ...
        name: 'spliting_ratio',
        type: 'number',
        placeholder: 'Fraction spliting ratio x (1/x)',
        label: 'Spliting ratio',
        variant: 'outlined',
        required: true,
        xs: 12,
        sm: 12,
      ...
      //  but then the value is not read or sent via API
      {
        ...
        name: 'submethod',
        type: 'text',
        placeholder: 'Pick or enter one',
        label: 'Sub Method',
        variant: 'outlined',
        fullWidth: true,
        required: true,
        xs: 12,
        sm: 6, //sx:{m:0, minWith:300},
        choice: [
          { id: 1, value: 'Motoda' },
          { id: 2, value: 'Johnson' },
          { id: 3, value: '<NAME>' },
...
export const projectElements = [
  {
    ...
    section: [
      ...
      {
        name: 'drive',
        placeholder: 'Project thematic (tara, archives_lov, ...)',
        label: 'Project Drive',
      ...
      {
        name: 'acronym',
        placeholder: 'Project acronym (a quick name for you)',
...
export const projectEcotaxaElements = [
  {
    ...
    section: [
      {
        name: 'ecotaxa_project_name',
        placeholder: 'Ecoxata Project name',
        label: 'Ecoxata Project name',
        tag: 'TextField',
        type: 'text',
        variant: 'outlined',
        fullWidth: true,
      ...
      {
        name: 'ecotaxa_project_title',
        placeholder: 'Ecoxata Project title',
        label: 'Ecotaxa Project Title',
        required: false,
        disabled: true,
        tag: 'TextField',
        type: 'text',
      ...
      {
        name: 'ecotaxa_project',
        placeholder: 'Ecoxa Project id',
...
export const DriveElements = [
  {
    ...
    section: [
      {
        name: 'name',
        placeholder: 'Name to represent your drive, like "Zooscan Archive"',
        label: 'Drive Name',
        tag: 'TextField',
        type: 'text', //value:'Zooscan Archive',
        required: true,
        disabled: false,
        trad: 'drive_name',
        variant: 'outlined',
      ...
      {
        name: 'url',
        placeholder: 'The path where your scan will be save',
        label: 'Path',
        tag: 'TextField',
        type: 'text', //value:'Zooscan Archive',
        required: true,
...
export const DriveForm = [DriveElements];
...
export const scannerElements = [
  {
    ...
    section: [
      ...
      {
        name: 'name',
        placeholder: 'Nickname of the Instrument',
        label: 'Name',
        tag: 'TextField',
        type: 'text',
        trad: 'instrument_name',
        required: true,
        disabled: false,
        variant: 'outlined',
        fullWidth: true,
...
export const scannerElementsNew = [
  {
    ...
    section: [
      ...
      },
      {
        ...
        tag: 'TextField',
        type: 'text',
        trad: 'instrument_name_scanner_new',
        required: true,
        disabled: false,
        variant: 'outlined',
        fullWidth: true,
